insert into authority (type) values ('ROLE_USER');
insert into authority (type) values ('ROLE_ADMIN');
...
insert into account_authority (account_id, authority_id, create_at, modified_at) values (1, 1, now(), now());
insert into account_authority (account_id, authority_id, create_at, modified_at) values (1, 2, now(), now());
insert into account_authority (account_id, authority_id, create_at, modified_at) values (2, 1, now(), now());